...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{figures/langchain_document_object_creation_with_chunk_metadata.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{chroma_metadata_filter_construction_for_transcript_scoping.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{bm25_scoring_and_top_k_ranking.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{bm25_result_document_construction.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{bm25_index_persistence_via_pickle_serialization.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{phonetic_index_database_schema_with_sqlite_table_and_indices.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{phonetic_index_building_with_batch_insertion.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{phonetic_retrieval_sql_query_without_filtering.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{fetching_candidate_document_pool_for_fuzzy_matching.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{request_payload_preparation.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{sorting_by_relevance_score.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{human_message_template_with_reasoning_suppression_directive.png}

...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{document_processing_pipeline.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{vector_store_creation_from_documents.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{incremental_document_addition.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{vector_search_core_function_showing_semantic_retrieval_with_optional_c.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{bm25_tokenization_function_using_lowercase_split.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{bm25_index_initialization_with_corpus_tokenization.png}
  \caption{BM25 index initialization with corpus tokenization}
  \label{fig:fig28b}
\end{figure}

\textbf{Querying, Scoring and Ranking}

At query time, the BM25 retriever tokenizes the input query using the same tokenization logic applied during indexing to ensure consistency. The retrieval function supports optional metadata-based filtering to restrict results to specific transcripts, as demonstrated in Figure \ref{fig:fig28c}. The system first identifies document indices matching the specified metadata field and value, then invokes the optimized get\_batch\_scores method to compute BM25 scores only for the filtered subset of documents.

\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{bm25_query_tokenization_and_metadata_filtering.png}
  \caption{BM25 query tokenization and metadata filtering}
  \label{fig:fig28c}
\end{figure}

After computing BM25 scores for candidate documents, the retriever ranks results by score in descending order and selects the top-k highest-scoring chunks.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{phonetic_word_tokenization_and_filtering.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{double_metaphone_phonetic_encoding.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{phonetic_retrieval_sql_query_with_transcript_filtering.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{phonetic_score_conversion_and_document_retrieval.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{rare_token_detection_using_zipf_frequency.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{extracting_rare_tokens_from_query.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{fuzzy_scoring_algorithm_setup_and_initialization.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{fuzzy_scoring_algorithm_nested_loop_with_rapidfuzz_ratio.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{fuzzy_top_k_selection_and_ranking.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{top_n_selection.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{chunk_formatting_with_individual_metadata_headers.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{output_format_example.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{citation_formatting_for_user_transparency_and_source_attribution.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{rag_system_message_template_defining_assistant_role_and_constraints.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{complete_rag_chat_prompt_construction_with_history_support.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{chat_history_structure_for_multi_turn_conversation_support.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{streaming_response_handling_for_real_time_token_display.png}

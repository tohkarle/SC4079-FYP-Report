...
\subsubsection{Keyword-Based Retrieval}
...
\subsubsection{LLM-Based Conversational Retrieval (Otter AI Chat)}
...
\subsubsection{LLM-Based Summarization}
...
Meadow9+ is a mobile speech-to-text application developed by researchers from the NTU Speech and Language Laboratory, with initial development dating back to approximately 2021 \cite{meadow9_appstore_au,abax_ai_site}. It is a product of ABAX AI, a company specializing in advanced speech recognition technologies tailored for enterprise and professional use cases \cite{abax_ai_site,abax_ai_companies_sg}.
...
\subsubsection{Text-Matching Search}
...
\subsubsection{LLM-Based Conversational Retrieval}

...
\textbf{Explore extensible retrieval techniques tailored to noisy ASR transcripts}, enabling efficient date-based and keyword-based retrieval in addition to chatbot-driven querying. This part is still a work in progress. The exact detail will be provided in the final report once everything has been finalized.
